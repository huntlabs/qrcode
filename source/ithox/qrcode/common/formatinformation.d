...
class FormatInformation
{
	...
	*/
    public static int numBitsDiffering(int a, int b)
    {
        a ^= b;
        return (
				bitsSetInHalfByte[a & 0xf]
				+ bitsSetInHalfByte[(BitUtils.unsignedRightShift(a, 4) & 0xf)]
				+ bitsSetInHalfByte[(BitUtils.unsignedRightShift(a, 8) & 0xf)]
				+ bitsSetInHalfByte[(BitUtils.unsignedRightShift(a, 12) & 0xf)]
				+ bitsSetInHalfByte[(BitUtils.unsignedRightShift(a, 16) & 0xf)]
				+ bitsSetInHalfByte[(BitUtils.unsignedRightShift(a, 20) & 0xf)]
				+ bitsSetInHalfByte[(BitUtils.unsignedRightShift(a, 24) & 0xf)]
				+ bitsSetInHalfByte[(BitUtils.unsignedRightShift(a, 28) & 0xf)]
				);
    }
	...
	* @return FormatInformation|null
	*/
    protected static FormatInformation doDecodeFormatInformation(int maskedFormatInfo1, int maskedFormatInfo2)
    {
	...
	*/
    public bool equals(FormatInformation other) {
        ...
        return (
				ecLevel == other.getErrorCorrectionLevel()
				&& dataMask == other.getDataMask()
					);
    }
}