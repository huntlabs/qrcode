module ithox.qrcode.encoder.qrcode;
...
class QrCode
{
	...
	*/
	...
	public @property Mode mode(){return _mode;}
	public @property void mode(Mode _m){ _mode = _m;}

	public @property ErrorCorrectionLevel errorCorrectionLevel(){return _errorCorrectionLevel;}
	public @property void errorCorrectionLevel(ErrorCorrectionLevel _m){ _errorCorrectionLevel = _m;}

	public @property QrCodeVersion qrVersion(){return _qrVersion;}
	public @property void qrVersion(QrCodeVersion _m){ _qrVersion = _m;}


	public @property int maskPattern(){return _maskPattern;}
	public @property void maskPattern(int _m){ _maskPattern = _m;}

	public @property ByteMatrix matrix(){return _matrix;}
	public @property void matrix(ByteMatrix _m){ _matrix = _m;}
