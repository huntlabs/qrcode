...
class Mode
{
	...
	*/
    ...
    public @property int mode()
    {
        return this._mode;
    }

    public @property void mode(int _m)
    {
        this._mode = _m;
    }
    /**
...
TERMINATOR : [0, 0, 0
    ], NUMERIC : [10, 12, 14], ALPHANUMERIC : [
        9, 11, 13
    ], STRUCTURED_APPEND : [0, 0, 0], BYTE : [
        8, 16, 16
    ], ECI : [0, 0, 0], KANJI : [
        8, 10, 12
    ], FNC1_FIRST_POSITION : [0, 0, 0], FNC1_SECOND_POSITION : [0, 0, 0], HANZI : [8, 10, 12],];
